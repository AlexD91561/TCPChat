...
namespace Client
{
    public partial class PublicChatForm : Form
    {
        ...
        protected override void OnLoad(EventArgs e)
        {
            ...
            Text = "Mesaje - " + formLogin.txtIP.Text + " - (Conectat ca utilizatorul " + formLogin.txtNickname.Text + ")";
        ...
        public void _client_Received(ClientSettings cs, string received)
        {
            ...
            switch (cmd[0])
            {
                ...
                case "pMessage":
                    this.Invoke(() =>
                    {
                        pChat.txtReceive.Text += "Server: " + cmd[1] + "\r\n";
                    });
                    break;
                case "Disconnect":
                    Application.Exit();
        ...
        private void btnSend_Click(object sender, EventArgs e)
        {
            if (txtInput.Text != string.Empty)
            {
                ...
                txtReceive.Text += formLogin.txtNickname.Text + ": " + txtInput.Text + "\r\n";
